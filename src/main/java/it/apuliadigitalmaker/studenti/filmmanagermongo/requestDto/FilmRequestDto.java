...
public class FilmRequestDto {
	...
	private Set<ActorRequestDto> actors = new HashSet<>();
	...
	public Set<ActorRequestDto> getActors() {
		return actors;
	}

	public void setActors(Set<ActorRequestDto> actors) {
		this.actors = actors;
	}
	...
	public String toString() {
		return "FilmRequestDto [title=" + title + ", description=" + description + ", releaseYear=" + releaseYear
	...
	public FilmRequestDto(String title, String description, Integer releaseYear, String language,
			Integer rentalDuration, Double rentalRate, Integer length, Double replacementCost, RatingEnum rating,
			String specialFeatures, String fulltext, Set<ActorRequestDto> actors, Set<String> categories) {
		super();
		this.title = title;
		this.description = description;
		this.releaseYear = releaseYear;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FilmRequestDto other = (FilmRequestDto) obj;
		if (actors == null) {
